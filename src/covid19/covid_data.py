...
def load_jhu_data():
    ...
    for country_data in vac_data:
        ...
        for date_data in country_data['data']:
            ...
            date_to_vac_data[unixtime] = {
                'cum_vaccinations': date_data.get('total_vaccinations', 0),
                'cum_people_vaccinated': date_data.get('people_vaccinated', 0),
                'cum_people_fully_vaccinated': date_data.get(
    ...
    def _cleaned_timeseries_item(item, prev_item, country_alpha_3):
        ...
        cleaned_item['new_vaccinations'] = cleaned_item[
            'cum_vaccinations'
        ] - prev_item.get('cum_vaccinations', 0)
        cleaned_item['new_people_vaccinated'] = cleaned_item[
            'cum_people_vaccinated'
        ] - prev_item.get('cum_people_vaccinated', 0)
        cleaned_item['new_people_fully_vaccinated'] = cleaned_item[
            'cum_people_fully_vaccinated'
